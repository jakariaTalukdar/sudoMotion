  ...
  return (
    <section className="customRadialGreadiant py-16 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            {/* Web */}
            <Reveal delay={60} className="flex flex-col items-start text-start border-gray-500 p-4 rounded-md bg-[#ffffff1f] backBlur hover:translate-y-[-2px] transition-transform duration-300">
            ...
            {/* App */}
            <Reveal delay={120} className="flex flex-col items-start text-start border-gray-500 p-4 rounded-md bg-[#ffffff1f] backBlur hover:translate-y-[-2px] transition-transform duration-300">
            ...
            {/* Video */}
            <Reveal delay={180} className="flex flex-col items-start text-start border-gray-500 p-4 rounded-md bg-[#ffffff1f] backBlur hover:translate-y-[-2px] transition-transform duration-300">
