    ...
    <section className="customRadialGreadiant py-16 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col items-start text-start border-gray-500 p-4 rounded-md bg-[#ffffff1f] backBlur">
                <img src="/Image/web.png" alt="web development" className="size-20 md:size-32 object-contain mb-4" />
            ...
            {/* Cold Beverages */}
            <div className="flex flex-col items-start text-start border-gray-500 p-4 rounded-md bg-[#ffffff1f] backBlur">
                <img src="/Image/app.png" alt="Cold Beverages" className="size-20 md:size-32 object-contain mb-4" />
            ...
            {/* Refreshment */}
            <div className="flex flex-col items-start text-start border-gray-500 p-4 rounded-md bg-[#ffffff1f] backBlur">
                <img src="/Image/video.png" alt="Refreshment" className="size-20 md:size-32 object-contain mb-4" />
